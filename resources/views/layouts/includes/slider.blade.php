            ...
            <div class="swiper-slide flex items-center justify-center">
                <div class="container mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center h-full">
                    <div class="text-center lg:text-left space-y-4 animate-fadeIn">
                        <h2 class="text-4xl lg:text-6xl font-bold text-gray-800 leading-tight">New Stylish <br /> Decor
                            Furniture</h2>
            ...
            <div class="swiper-slide flex items-center justify-center">
                <div class="container mx-auto px-4 grid lg:grid-cols-2 gap-8 items-center h-full">
                    <div class="text-center lg:text-left space-y-4">
                        <h2 class="text-4xl lg:text-6xl font-bold text-gray-800 leading-tight">Modern Living <br /> Room
                            Sets</h2>
