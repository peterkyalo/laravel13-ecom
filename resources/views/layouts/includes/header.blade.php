            ...
            <div class="w-1/4 flex justify-end items-center space-x-6">
                ...
                <div class="relative group">
                    ...
                    <ul
                        ...
                        @guest
                            <li><a href='{{ route('login') }}' class="block px-4 py-2 hover:bg-gray-100 text-sm">Sign In</a>
                            </li>
                            <li><a href='{{ route('register') }}' class="block px-4 py-2 hover:bg-gray-100 text-sm">Sign
                                    Up</a>
                            </li>
                        @else
                            <li><a href="{{ Auth::user()->user_type == 'admin' ? route('admin.index') : route('users.index') }}"
                                    class="block px-4 py-2 hover:bg-gray-100 text-sm">My Account</a>
                            </li>
                            <li>
                                <a href="{{ route('logout') }}"
                                    onclick="event.preventDefault(); document.getElementById('logout-form').submit()"
                                    class="block px-4 py-2 hover:bg-gray-100 text-sm">Sign
                                    Out</a>
