                ...
                <div class="w-full lg:w-1/4">
                    <div class="bg-gray-50 border rounded overflow-hidden">
                        <ul class="flex flex-col divide-y">
                            <li>
                                <button
                                    class="account-tab-btn active w-full text-left px-6 py-4 transition flex items-center gap-3"
                            ...
                            <li>
                                <button
                                    class="account-tab-btn w-full text-left px-6 py-4 transition flex items-center gap-3"
                                    data-target="orders">
